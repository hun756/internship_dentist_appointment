    ...
    <div class="app-sidebar colored">
        <div class="sidebar-header">
            <a class="header-brand" href="index.html">
                ...
                <span class="text">Dental Clinic</span>
            </a>
            ...
            <div class="nav-container">
                <nav id="main-menu-navigation" class="navigation-main">
                    ...
                    <div class="nav-item has-sub">
                        <a href="javascript:void(0)"><i class="ik ik-user"></i><span>Dentist</span> <span class="badge badge-danger"></span></a>
                        <div class="submenu-content">
                            <a href="{{ route('dentist.create') }}" class="menu-item">Create</a>
                            <a href="{{ route('dentist.index') }}" class="menu-item">View</a>
                        </div>
                    </div>
                    <div class="nav-item has-sub">
                        <a href="javascript:void(0)"><i class="ik ik-star"></i><span>Appointment Time</span> <span class="badge badge-danger"></span></a>
                        <div class="submenu-content">
